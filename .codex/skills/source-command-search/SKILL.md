---
name: "source-command-search"
description: "Perplexity API 실시간 웹 검색 — perplexity_tool.js 호출"
---

# source-command-search

Use this skill when the user asks to run the migrated source command `search`.
...
**Step 1 — 인자 확인**
- 사용자 인자(검색어)가 없으면 "검색어를 입력해주세요" 요청 후 대기.

**Step 2 — 검색 실행**
```bash
node arsenal/perplexity_tool.js "<검색어>"
```
