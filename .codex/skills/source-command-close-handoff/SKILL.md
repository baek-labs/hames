---
name: "source-command-close-handoff"
description: "완료된 핸드오프 파일을 _Archive로 이동 — close_handoff.ps1 실행"
---

# source-command-close-handoff

Use this skill when the user asks to run the migrated source command `close-handoff`.
