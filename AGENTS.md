...
- Keep Core limited to `/setup`, `/ready`, `/go`, and `/doctor`. Preserve the same-session present-to-go approval contract, dependency-aware progress, proportional independent review, and approved durable-knowledge destinations. Optional packs belong behind documented extension points.
