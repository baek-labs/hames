...
Write durable knowledge only to approved destinations and record each as applied or deferred with `record-knowledge`. For useful discoveries outside them, show the exact proposed change and obtain separate approval before recording it. This does not authorize editing host memory.
